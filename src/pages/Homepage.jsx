...
const Homepage = () => {
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <section className="bg-[url('/book2.jpg')] bg-no-repeat bg-cover w-full h-full text-black text-center py-52">
      <div className="max-w-screen-lg mx-auto px-6">
          ...
          <a
            href="products"
            className="bg-pink-600 text-white py-2 px-6 rounded-lg font-semibold text-lg hover:bg-gray-400 transition duration-300"
          >
            Browse Products
          </a>
        </div>
